...
/*
 * Класс структуры данных из таблицы data_patterns, хранящей логику добавления и отображения данных
 * 
 * $name - название шаблона, для отображения на человеческом языке(чтобы было типа "выберите Здание" а не "выберите buildings")
 * $rights - массив, содержащий внешние ключи на таблицу special_rights. Указывает, какие права могут понадобиться для чтения
 * или добавления/редактирования строк
 */
